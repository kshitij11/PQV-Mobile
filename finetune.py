...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        lr_scheduler.step()
        evaluate(model, criterion, data_loader_test, device=device)
        #path = "./finetuned_output/model_finetune_taylor_0.0859375" + "_" + str(epoch)+ ".pth"
        path = args.path + "_" + str(epoch)+ ".pth"
        #torch.save(model.module, "./finetuned_output/model_finetune_taylor_0.25.pth")
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument(
        "--path", default="./finetuned_output/model_finetune_taylor_0.25", type=str, help="path for the finetuned model to be saved every epoch (./finetuned_output/model_finetune_taylor_0.25)"
    )
    return parser
